...
const handleDiscountTypeChange = () => {
    ...
    if (selectedType === 'percentage_discount') stackPercentage.style.display = 'block';
    else if (selectedType === 'fixed_amount_discount') stackFixed.style.display = 'block';
    else if (selectedType === 'shipping_discount') stackShipping.style.display = 'block';
};
...
function updateDiscountSummary() {
    if (!discountTypeChoiceList) return;

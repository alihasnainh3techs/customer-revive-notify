...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,read_customers,read_themes'),
    ...
    'webhooks' => [
        ...
        */
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://leonora-siltier-janay.ngrok-free.dev/webhook/app-uninstalled')
        ],
    ],
